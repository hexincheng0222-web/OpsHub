...
export const mockRacks: Rack[] = [
  {
    ...
    totalU: 42,
    devices: [
      { id: 1, name: 'PDU-A1', type: 'pdu', model: 'APC 3kW', u: 1, ports: 0, status: '正常' },
      { id: 2, name: 'PDU-A2', type: 'pdu', model: 'APC 3kW', u: 1, ports: 0, status: '正常' },
      null,
      ...
      { id: 17, name: 'UPS-A', type: 'ups', model: 'SANTAK 20KVA', u: 3, ports: 0, status: '正常' },
    ]
  },
  {
    id: 'rack-b1',
    ...
    totalU: 42,
    devices: [
      { id: 18, name: 'PDU-B1', type: 'pdu', model: 'APC 5kW', u: 1, ports: 0, status: '正常' },
      { id: 19, name: 'PDU-B2', type: 'pdu', model: 'APC 5kW', u: 1, ports: 0, status: '正常' },
      null, null,
      ...
      { id: 30, name: 'UPS-B', type: 'ups', model: 'SANTAK 30KVA', u: 3, ports: 0, status: '正常' },
    ]
  },
  {
    id: 'rack-a2',
    ...
    totalU: 12,
    devices: [
      { id: 31, name: 'Web-01', type: 'server', model: 'Dell R650', u: 1, ports: 4, status: '正常' },
      null,
      { id: 32, name: 'Web-02', type: 'server', model: 'Dell R650', u: 1, ports: 4, status: '正常' },
    ]
  },
  {
    id: 'rack-b2',
    ...
    totalU: 42,
    devices: [
      { id: 36, name: 'Dev-01', type: 'server', model: 'Dell R650', u: 1, ports: 4, status: '正常' },
      { id: 37, name: 'Dev-02', type: 'server', model: 'Dell R650', u: 1, ports: 4, status: '正常' },
